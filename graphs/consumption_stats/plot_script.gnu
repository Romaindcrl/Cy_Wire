...
plot "output/lv_all_minmax.csv" using (column(4)<0?-column(4):1/0):xtic(1) with boxes lc rgb "red" title "Surcharge (kWh)",      "" using (column(4)>=0?column(4):1/0) with boxes lc rgb "green" title "Sous-charge (kWh)"
